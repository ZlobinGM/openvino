...
const std::unordered_map<PowerConfig, std::string>& power2string() {
    static const std::unordered_map<PowerConfig, std::string> converters = {
        {PowerConfig::FULL,         InferenceEngine::MYRIAD_POWER_FULL},
        {PowerConfig::INFER,        InferenceEngine::MYRIAD_POWER_INFER},
        {PowerConfig::STAGE,        InferenceEngine::MYRIAD_POWER_STAGE},
        {PowerConfig::STAGE_SHAVES, InferenceEngine::MYRIAD_POWER_STAGE_SHAVES},
        {PowerConfig::STAGE_NCES,   InferenceEngine::MYRIAD_POWER_STAGE_NCES},
    };
    return converters;
}

const std::unordered_map<std::string, PowerConfig>& string2power() {
    static const auto converters = inverse(power2string());
    return converters;
}
